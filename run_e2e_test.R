...
saveRDS(qc_results, file.path(data_dir, "qc.rds"))
saveRDS(merged_annotations, file.path(data_dir, "variants.rds"))
saveRDS(parsed_cnv_sig, file.path(data_dir, "cnv.rds"))
saveRDS(parsed_fusions, file.path(data_dir, "fusions.rds"))
saveRDS(tmb_result, file.path(data_dir, "tmb.rds"))
saveRDS(msi_result, file.path(data_dir, "msi.rds"))
saveRDS(hrd_result, file.path(data_dir, "hrd.rds"))
saveRDS(oncokb_results, file.path(data_dir, "oncokb.rds"))
saveRDS(escat_tiers, file.path(data_dir, "escat.rds"))
saveRDS(literature_results, file.path(data_dir, "literature.rds"))
